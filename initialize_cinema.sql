...
/* Saal mit leeren Sitzen = "" 
    Format: die ersten beiden Zahlen geben die Reihe und die Sitzplatznummer an. der Buchstabe dahinter soll entweder 'f' oder 'b' sein und bedeutet 'frei' oder 'besetzt'.*/
